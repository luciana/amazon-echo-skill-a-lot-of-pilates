...
exerciseOutput158 += "<break time=\"2s\" />. ";
exerciseOutput158 += "Extend your legs up towards the ceiling. Squeeze the thighs together and begin pulling your navel to your spine.";
exerciseOutput158 += "<break time=\"0.2s\" />. ";
exerciseOutput158 += "Inhale and begin tilting your pelvis to peel your tailbone off the floor.";
exerciseOutput158 += "<break time=\"0.2s\" />. ";
exerciseOutput158 += "Exhale and dynamically peel your spine off the floor until you are resting carefully on the shoulders";
...
exerciseOutput158 += "<break time=\"0.2s\" />. ";
exerciseOutput158 += "Inhale using your abs to pull the legs back, tilt the pelvis, and begin exhaling into the roll over again.";
exerciseOutput158 += "<break time=\"0.3s\" />. ";
exerciseOutput158 += "Repeat a few more times.";
exerciseOutput158 += "<break time=\"3s\" />. ";
...
exerciseOutput160 += "<break time=\"0.1s\" />. ";
exerciseOutput160 += "Be careful not to roll too far back onto the neck, control is necessary";
exerciseOutput160 += "<break time=\"0.2s\" />. ";
...
//SINGLE LEG CIRCLE
var exerciseOutput287 = "Lay on your back with your legs extended in front of you.";
...
exerciseOutput287 += "Exhale the leg down around and up in a counterclockwise motion.";
exerciseOutput287 += "<break time=\"1s\" />. ";
exerciseOutput287 += "Do it four more times and reverse to a clockwise motion 5 more times.";
exerciseOutput287 += "<break time=\"8s\" />. ";
exerciseOutput287 += "Switch legs.";
...
exerciseOutput310 += "<break time=\"10s\" />. ";

//SINGLE LEG STRETCH
var exerciseOutput315 = "Lie on your back, knees in tabletop";
exerciseOutput315 += "<break time=\"0.2s\" />. ";
exerciseOutput315 += "Inhale as you curl your chin towards your chest. Put your hands on your right knee";
exerciseOutput315 += "<break time=\"0.1s\" />. ";
exerciseOutput315 += "Exhale as you extend your left leg out away from you";
exerciseOutput315 += "<break time=\"1s\" />. ";
exerciseOutput315 += "Continue switching legs, keeping the torso still and only moving the arms and legs";
exerciseOutput315 += "<break time=\"1s\" />. ";
exerciseOutput315 += "Work towards inhaling for 2 counts and exhaling for 2 counts, allowing the legs to alternate.";
exerciseOutput315 += "<break time=\"2s\" />. ";
exerciseOutput315 += "Repeat a few more times.";
exerciseOutput315 += "<break time=\"10s\" />. ";
exerciseOutput315 += "<break time=\"3s\" />. ";


//OPEN LEG ROCKER
var exerciseOutput318 = "Begin seated on your sitzbones, legs about mat's width apart, knees bent.";
exerciseOutput318 += "<break time=\"1.3s\" />. ";
exerciseOutput318 += "Tilt your pelvis back a little to find balance as you carefully lift your right leg off the mat, then your left leg.";
exerciseOutput318 += "<break time=\"0.8s\" />. ";
exerciseOutput318 += "Inhale and roll back, nodding your chine forward towards the chest to protect the neck.";
exerciseOutput318 += "<break time=\"0.4s\" />. ";
exerciseOutput318 += "Exhale and roll forward to the beginning position";
exerciseOutput318 += "<break time=\"8s\" />. ";
exerciseOutput318 += "<break time=\"9s\" />. ";
...
//REST POSE            
var exerciseOutput327 = "Begin on your hands and knees. Knees about hip width apart.";
exerciseOutput327 += "<break time=\"0.2s\" />. ";
exerciseOutput327 += "Rest your butt on your heels.  Allow your hips to sink back into your heels";
exerciseOutput327 += "<break time=\"0.2s\" />. ";
...
exerciseOutput327 += "<break time=\"5s\" />. ";


//BASIC BRIDGE
var exerciseOutput511 = "Lay on your back with your knees bent. Place your heels under the knees";
...
exerciseOutput545 += "<break time=\"1s\" />. ";
exerciseOutput545 += "Exhale and squeeze the pelvic bones towards one another. Feel your spine begin to curl from the tail to the head ending with your chin curled to the chest";
exerciseOutput545 += "<break time=\"1s\" />. ";
...
//HUNDRED
var exerciseOutput266 = "Get in position for the Hundred. Lay on your back with your knees in table top.";
...
exerciseOutput266 += "<break time=\"2s\" />. ";
...
exerciseOutput266 += "<break time=\"8s\" />. ";
...
exerciseOutput266 += "<break time=\"5s\" />. ";
...
exerciseOutput273 += "<break time=\"10s\" />. ";
exerciseOutput273 += "<break time=\"8s\" />. ";

//Spine Twist
var exerciseOutput276 = "From a seated position, straighten your legs in front of you. Flex both feet.";
exerciseOutput276 += "<break time=\"2s\" /> ";
exerciseOutput276 += " Seat nice and tall and lift the arms out in a T shape";
...
exerciseOutput276 += "<break time=\"10s\" />. ";
exerciseOutput276 += "<break time=\"4s\" />. ";

//Spine Stretch Forward
var exerciseOutput289 = "Begin seated with your legs extended in front of you. Feet are flexed";
exerciseOutput289 += "<break time=\"0.5s\" /> ";
exerciseOutput289 += "Arms are straight in front of the shoulders parallel to the ground.";
exerciseOutput289 += "<break time=\"2s\" /> ";
exerciseOutput289 += "Inhale. ";
exerciseOutput289 += "<break time=\"0.4s\" /> ";
...
exerciseOutput289 += "<break time=\"1.5s\" /> ";
exerciseOutput289 += "Exhale to roll back up slowly.";
exerciseOutput289 += "<break time=\"10s\" /> ";
exerciseOutput289 += "<break time=\"5s\" /> ";

//Swan
var exerciseOutput291 = "Lay on your belly with hands under the shoulders, elbows back towards the ribs and palms pressing down.";
...
var exerciseOutput487 = "Begin kneeling on your hands and knees with knees are under the hips and the hands are under the shoulders.";
exerciseOutput487 += "<break time=\"2s\" /> ";
exerciseOutput487 += "Inhale and extend your right arm straight out in front of you extending the left leg straight out behind you.";
...
exerciseOutput487 += "Inhale and extend your left arm straight out in front of you while also extending the right leg straight out behind you.";
exerciseOutput487 += "<break time=\"5s\" /> ";
exerciseOutput487 += "Repeat very slowly with control";
exerciseOutput487 += "<break time=\"10s\" /> ";

//Reverse Plank
var exerciseOutput547 = "Begin seated with your hands placed on the ground" ;
...
exerciseOutput547 += "<break time=\"10s\" />. ";
exerciseOutput547 += "<break time=\"4s\" />. ";

//DOUBLE LEG STRETCH
var exerciseOutput451 = "Lie on your back with your knees pulled close to the chest. Place your hands on your shins, and keep elbows wide.";
...
exerciseOutput499 += "Inhale as you lower both legs. Keep the knee at ninety degree angle.";
...
var exerciseOutput528 = "Lay on your back with your knees bent and lift your legs to tabletop";
exerciseOutput528 += "<break time=\"0.7s\" />. ";
exerciseOutput528 += "Inhale. Lower your right leg keeping the knee at 90 degree angle.";
exerciseOutput528 += "<break time=\"0.6s\" />. ";
...
exerciseOutput528 += "<break time=\"6s\" />. ";
exerciseOutput528 += "<break time=\"10s\" />. ";

//Basic Upper Ab Curl/Chest Lift/Thoracic curl
var exerciseOutput529 = "Lay on your back. Lift both legs to tabletop and place your arms behind your head.";
...
exerciseOutput536 += "Inhale and begin swaying your knees together with control to the right.";
exerciseOutput536 += "<break time=\"2s\" />. ";
exerciseOutput536 += "Exhale and bring the knees back to center.";
exerciseOutput536 += "<break time=\"2s\" />. ";
exerciseOutput536 += "Inhale and sway knees to the left keeping your knees together.";
exerciseOutput536 += "<break time=\"4s\" />. ";
exerciseOutput536 += "Exhale and return to center.";
...
exerciseOutput541 += "Exhale and roll down slowly";
exerciseOutput541 += "<break time=\"2.5s\" />. ";
exerciseOutput541 += "Inhale and pause at the bottom,";
exerciseOutput541 += "<break time=\"0.5s\" />. ";
exerciseOutput541 += "Exhale and pull your navel up to come up. Head comes up last.";
...
exerciseOutput631 += "Inhale as you roll back pulling the lower abdominals in deeply. Curve in your spine, like the letter C.";
...
var exerciseSideLegSeries = "Lie on one side with bottom arm bent for head to lay on. Position the legs about 45 degrees in front of the body";
...
exerciseSideLegSeries += "<break time=\"10s\" />. ";
exerciseSideLegSeries += "<break time=\"10s\" />. ";
exerciseSideLegSeries += "Switch sides and start";
exerciseSideLegSeries += "<break time=\"5s\" /> ";
exerciseSideLegSeries += "<break time=\"10s\" /> ";
exerciseSideLegSeries += "<break time=\"10s\" /> ";
exerciseSideLegSeries += "<break time=\"10s\" /> ";
...
exercises[158] = {
    exerciseDescription: exerciseOutput158,
    exerciseName: "Roll Over"};
...
exercises[287] = {
    exerciseDescription: exerciseOutput287,
...
exercises[315] = {
    exerciseDescription: exerciseOutput315,
    exerciseName: "Single Leg Stretch"};

exercises[318] = {
    exerciseDescription: exerciseOutput318,
    exerciseName: "Open Leg Rocker"};
